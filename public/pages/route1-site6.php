          ...
          <div class="col-xs-12 col-sm-6">
            <div class="row">
              ...
              <div class="col-5">
                <div class="col-12 smallRouteSitePic smallRouteSitePic1">
                  <img
                    src="../images/route1/1.School Building/6. School of Chemical Engineering/2.jpg"
                    alt=""
                  />
                </div>
                <div class="col-12 smallRouteSitePic smallRouteSitePic2">
                  <img
                    src="../images/route1/1.School Building/6. School of Chemical Engineering/3.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12 routeSpotIntro">
                The Väre building is the new home to all departments of the
                School of Arts, Design and Architecture and has been designed
                according to user-centric and sustainable principles.
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                <a href="./route1-complete.php">
