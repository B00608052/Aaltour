          ...
          <div class="col-xs-12 col-sm-6">
            <div class="row">
              <div class="col-7">
                <div class="col-12 firstRouteSitePic">
                  <img
                    src="../images/route2/2.Life instruction/2.Undergraduate center/1.jpg"
                    alt=""
                  />
                </div>
              </div>
              <div class="col-5">
                ...
                <div class="col-12 smallRouteSitePic smallRouteSitePic2">
                  <img
                    src="../images/route2/2.Life instruction/2.Undergraduate center/4.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12 routeSpotIntro">
                Aalto University's Undergraduate Center, previously known as the
                Helsinki University of Technology main building, sits on one of
                the area's seven hilltops and is one of the campus' prime
                landmarks. As the name hints, this is where most undergraduate
                students start their Bachelor's studies. The impressive roof of
                the auditorium forms an amphitheater that merges with the nearby
                park.
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                <a href="./route2-stop3.php">
