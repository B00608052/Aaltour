          ...
          <div class="col-xs-12 col-sm-6">
            <div class="row">
              ...
              <div class="col-5">
                <div class="col-12 smallRouteSitePic smallRouteSitePic1">
                  <img
                    src="../images/route1/1.School Building/3. School of Business /2.jpg"
                    alt=""
                  />
                </div>
                <div class="col-12 smallRouteSitePic smallRouteSitePic2">
                  <img
                    src="../images/route1/1.School Building/3. School of Business /3.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12 routeSpotIntro">
                The building exudes the famous spirit of School of Business and
                its interior design is inspired by the unique solutions of the
                building in Töölö. Future residents have been consulted at all
                stages of the design of the new building: staff, students and
                alumni. School of Business building is a part of a larger
                building block, and it’s two other parts are Väre, the School of
                Arts, Design and Architecture’s new building and the shopping
                centre A Bloc. The block was designed by Verstas Architects,
                consisting of the alumni of Aalto University, which won the
                international architectural competition held 2012-2013. 189
                proposals were entered in the competition. The main designer is
                Jussi Palva.
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                <a href="./route1-stop4.php">
