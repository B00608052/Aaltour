                    ...
                    if (navigator.geolocation) {
                      navigator.geolocation.getCurrentPosition(
                        function (position) {
                          ...
                          var destination = {
                            lat: 60.187790258878714,
                            lng: 24.822440939833744,
                          };
          ...
          <div class="col-xs-12 col-sm-6">
            <div class="row">
              ...
              <div class="col-5">
                <div class="col-12 smallRouteSitePic smallRouteSitePic1">
                  <img
                    src="../images/route5/5.special Study space/4.Glass communication room/4.jpg"
                    alt=""
                  />
                </div>
                <div class="col-12 smallRouteSitePic smallRouteSitePic2">
                  <img
                    src="../images/route5/5.special Study space/4.Glass communication room/2.png"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12 routeSpotIntro">
                In this area there is an enclosed glass room, and at first
                glance you would think it is a small library. There are often
                some fun activities going on here, and of course each individual
                small space provides an excellent option for groups who want to
                study and discuss together. These individual meeting rooms can
                be reserved or the projection equipment in them can be used.
                There is a printer at the entrance of the main gate for students
                to use, which is very convenient.
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                <a href="./route5-complete.php">
