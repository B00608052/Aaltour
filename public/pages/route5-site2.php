                    ...
                    if (navigator.geolocation) {
                      navigator.geolocation.getCurrentPosition(
                        function (position) {
                          ...
                          var destination = {
                            lat: 60.18551288374995,
                            lng: 24.827637078080734,
                          };
          ...
          <div class="col-xs-12 col-sm-6">
            <div class="row">
              ...
              <div class="col-5">
                <div class="col-12 smallRouteSitePic smallRouteSitePic1">
                  <img
                    src="../images/route5/5.special Study space/2.Circular study room/2.png"
                    alt=""
                  />
                </div>
                <div class="col-12 smallRouteSitePic smallRouteSitePic2">
                  <img
                    src="../images/route5/5.special Study space/2.Circular study room/7.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12 routeSpotIntro">
                There are some spherical areas on the lower level of the
                library, and if you think this is just for decorative purposes,
                you are missing a very interesting place to study. In order to
                make students more relaxed learning, when you want to lie down
                to read, or lean more casually, you can try to use this space,
                it will give you a different surprise.
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                <a href="./route5-stop3.php">
