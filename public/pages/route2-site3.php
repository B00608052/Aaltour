          ...
          <div class="col-xs-12 col-sm-6">
            <div class="row">
              <div class="col-7">
                <div class="col-12 firstRouteSitePic">
                  <img
                    src="../images/route2/2.Life instruction/3.Learning center/4.jpg"
                    alt=""
                  />
                </div>
              </div>
              <div class="col-5">
                ...
                <div class="col-12 smallRouteSitePic smallRouteSitePic2">
                  <img
                    src="../images/route2/2.Life instruction/3.Learning center/3.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12 routeSpotIntro">
                The beautiful HaraldHerlin Learning Centre, where learning and
                working is always fun. You can see some exciting exhibitions
                from the Aalto Community here as soon as you enter. One of the
                cool things about Aalto is that you have many opportunities to
                showcase your creativity and collaboration with people from
                different disciplines and backgrounds.
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                <a href="./route2-stop4.php">
