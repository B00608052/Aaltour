          ...
          <div class="col-xs-12 col-sm-6">
            <div class="row">
              <div class="col-7">
                <div class="col-12 firstRouteSitePic">
                  <img
                    src="../images/route4/4.Spare time/2.Polytechnical Students Museum/1.webp"
                    alt=""
                  />
                </div>
              </div>
              <div class="col-5">
                ...
                <div class="col-12 smallRouteSitePic smallRouteSitePic2">
                  <img
                    src="../images/route4/4.Spare time/2.Polytechnical Students Museum/3.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12 routeSpotIntro">
                The Polytechnical Students’ Museum is an absolute jewel of its
                kind. According to the International Council of Museums (ICOM),
                acting under Unesco, this is the only museum owned and
                maintained by students that concentrates on student culture. It
                presents aspects of the engineering student experience that are
                both visible and less known by means of objects and stories.
                Admission to the museum is free during university semesters on
                Sundays from 14:00 to 16:00. If you want to see more exhibitions
                in campus, keep an eye on temporary exhibitions published here:
                https://www.aalto.fi/en/school-of-arts-design-and-architecture-exhibitions
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                <a href="./route4-stop3.php">
