      ...
      >
        <div class="row">
          <div class="col-xs-12 col-sm-6">
            <div class="row">
              <h2 class="col-12 fs-1 fw-bold routeSpotTitle">Vastuu Rock</h2>
            </div>
            <div class="row">
                    ...
                    if (navigator.geolocation) {
                      navigator.geolocation.getCurrentPosition(
                        function (position) {
                          ...
                          var destination = {
                            lat: 60.185307104497824,
                            lng: 24.829907446486363,
                          };
            ...
            <div class="row">
              <div class="col-7">
                <div class="col-12 firstRouteSitePic">
                  <img src="../images/route3/3.Sculpture New/4/4.jpg" alt="" />
                </div>
              </div>
              <div class="col-5">
                <div class="col-12 smallRouteSitePic smallRouteSitePic1">
                  <img src="../images/route3/3.Sculpture New/4/2.jpg" alt="" />
                </div>
                <div class="col-12 smallRouteSitePic smallRouteSitePic2">
                  <img src="../images/route3/3.Sculpture New/4/3.jpg" alt="" />
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-12 routeSpotIntro">
                （Hannu Siren, 1995）The 250-metre-long rock cut on the sea-side
                ramp of the Otaniemi junction and the boulders placed in the
                area of the junction form a name called "Responsibility" a work
                of environmental art. On the edge of the pedestrian and bicycle
                path at the rock cut is a dark-coloured metal plate engraved
                with a description of the environmental artwork in Finnish,
                Swedish and English.
                <br />https://hannusiren.art/fi/17.html
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                <a href="./route3-stop5.php">
