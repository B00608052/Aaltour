                    ...
                    if (navigator.geolocation) {
                      navigator.geolocation.getCurrentPosition(
                        function (position) {
                          ...
                          var destination = {
                            lat: 60.18942734766014,
                            lng: 24.837295168990426,
                          };
            ...
            <div class="row">
              <div class="col-7">
                <div class="col-12 firstRouteSitePic">
                  <img src="../images/route3/3.Sculpture New/2/1.jpeg" alt="" />
                </div>
              </div>
              <div class="col-5">
                <div class="col-12 smallRouteSitePic smallRouteSitePic1">
                  <img src="../images/route3/3.Sculpture New/2/2.jpeg" alt="" />
                </div>
                <div class="col-12 smallRouteSitePic smallRouteSitePic2">
                  <img src="../images/route3/3.Sculpture New/2/3.jpeg" alt="" />
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-12 routeSpotIntro">
                Otaniemi Church is a Lutheran church located in the student
                village of the Otaniemi Campus of the University of Espoalto,
                Finland. Designed by architect couple Heikki and Kaiia Siren for
                an architectural competition in 1954, the church was completed
                in 1956 and inaugurated in 1957. The church is on a hill in the
                woods, surrounded by pine and birch trees. The main materials of
                the church are red brick and wood, linking the church to other
                brick buildings on campus, including the main university
                building designed by Alvar Aalto. The building is accessed from
                a walled courtyard, which also has a bell tower. The church
                itself passes a club room and has two brick side walls. Parallel
                walls "guide 1 from the secular view of nature to the spiritual
                view of nature" : the altar wall is made of glass, open to the
                nature of the Zhou State, and a white cross stands among the
                trees.
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                <a href="./route3-stop3.php">
