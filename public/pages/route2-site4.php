      ...
      >
        <div class="row">
          <div class="col-xs-12 col-sm-6">
            <div class="row">
              <h2 class="col-12 fs-1 fw-bold routeSpotTitle">Sports Field</h2>
            </div>
            <div class="row">
          ...
          <div class="col-xs-12 col-sm-6">
            <div class="row">
              ...
              <div class="col-5">
                <div class="col-12 smallRouteSitePic smallRouteSitePic1">
                  <img
                    src="../images/route2/2.Life instruction/4.play fround/4.webp"
                    alt=""
                  />
                </div>
                <div class="col-12 smallRouteSitePic smallRouteSitePic2">
                  <img
                    src="../images/route2/2.Life instruction/4.play fround/2.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12 routeSpotIntro">
                Otaniemi’s sports center boasts a grassy field, grounds for
                track and field, a skating area, two street basketball courts,
                three tennis courts and a jogging track. The Otahalli Sports
                Centre just beside the sport park, designed by Alvar Aalto, was
                completed for the 1952 Olympics. The building’s larger hall was
                at one time the country’s largest structure of its kind, and the
                span between its wooden rafters is 45 meters.
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                <a href="./route2-complete.php">
