          ...
          <div class="col-xs-12 col-sm-6">
            <div class="row">
              ...
              <div class="col-5">
                <div class="col-12 smallRouteSitePic smallRouteSitePic1">
                  <img
                    src="../images/route1/1.School Building/2. School of Electrical Engineering/2.jpg"
                    alt=""
                  />
                </div>
                <div class="col-12 smallRouteSitePic smallRouteSitePic2">
                  <img
                    src="../images/route1/1.School Building/2. School of Electrical Engineering/3.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12 routeSpotIntro">
                ...
                and far away – the School of Electrical Engineering is so much
                more than electricity and smart power grids, as we study many
                topics you might not initially associate with the electrical
                industry. We take part in solving the great challenges humanity
                is facing, such as climate change, the depletion of natural
                resources and an aging population.
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                <a href="./route1-stop3.php">
