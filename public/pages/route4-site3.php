          ...
          <div class="col-xs-12 col-sm-6">
            <div class="row">
              <div class="col-7">
                <div class="col-12 firstRouteSitePic">
                  <img
                    src="../images/route4/4.Spare time/3.Laajalahti Nature Reserve/3.webp"
                    alt=""
                  />
                </div>
              </div>
              <div class="col-5">
                <div class="col-12 smallRouteSitePic smallRouteSitePic1">
                  <img
                    src="../images/route4/4.Spare time/3.Laajalahti Nature Reserve/2.jpg"
                    alt=""
                  />
                </div>
            ...
            <div class="row">
              <div class="col-12 routeSpotIntro">
                Take a break and go for a walk around the Laajalahti
                NatureReserve, which is right next to the university campus
                area. The nature reserve is one the best bird wetlands within
                the Greater Helsinki region. The 40-kilometer Espoo Waterfront
                walkway begins from Laajalahtifollowing the beaches of
                Otaniemiall on the way to the border of the neighboring City of
                Kirkkonummi. Here’s a interesting story that happens in the
                Laajalahti Nature Reserve. On the trail of the flying squirrel
                https://aaltouniversity.shorthandstories.com/on-the-trailof-the-flyingsquirrel/index.html?_gl=1*1qa9nd6*_ga*MTI4Mzc4NzAwLjE2ODg3MzEwMDQ.*_ga_EMB9H9RNLE*MTcwMDg1NDE4Ny45NC4xLjE3MDA4NTQzMDEuMC4wLjA.
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                <a href="./route4-stop4.php">
