      ...
      >
        <div class="row">
          <div class="col-xs-12 col-sm-6">
            <div class="row">
              <h2 class="col-12 fs-1 fw-bold routeSpotTitle">Lab Visiting</h2>
            </div>
            <div class="row">
          ...
          <div class="col-xs-12 col-sm-6">
            <div class="row">
              ...
              <div class="col-5">
                <div class="col-12 smallRouteSitePic smallRouteSitePic1">
                  <img
                    src="../images/route4/4.Spare time/4.Lab Visiting/3.webp"
                    alt=""
                  />
                </div>
                <div class="col-12 smallRouteSitePic smallRouteSitePic2">
                  <img
                    src="../images/route4/4.Spare time/4.Lab Visiting/2.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="row">
              ...
              Let’s explore the forefront of electrical engineering at Aalto University's School of Electrical Engineering! The school offers an inside look at three cutting-edge laboratories: the Robotics Lab, Acoustics Lab, and Electronics-ICT Laboratory. These visits unveil the future of robotics, sound technology, and electronics. Immerse yourself in the world of autonomous systems, discover the science of sound, and explore groundbreaking research in electronics and ICT. 
For more information or to schedule a visit, check out here: https://www.aalto.fi/en/school-of-electrical-engineering/visit-the-school-of-electrical-engineering.
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                <a href="./route4-complete.php">
