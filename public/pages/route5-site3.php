                    ...
                    if (navigator.geolocation) {
                      navigator.geolocation.getCurrentPosition(
                        function (position) {
                          ...
                          var destination = {
                            lat: 60.18904155503318,
                            lng: 24.830000224807577,
                          };
          ...
          <div class="col-xs-12 col-sm-6">
            <div class="row">
              <div class="col-7">
                <div class="col-12 firstRouteSitePic">
                  <img
                    src="../images/route5/5.special Study space/3.Recliner music space/5.png"
                    alt=""
                  />
                </div>
              </div>
              <div class="col-5">
                <div class="col-12 smallRouteSitePic smallRouteSitePic1">
                  <img
                    src="../images/route5/5.special Study space/3.Recliner music space/2.png"
                    alt=""
                  />
                </div>
                <div class="col-12 smallRouteSitePic smallRouteSitePic2">
                  <img
                    src="../images/route5/5.special Study space/3.Recliner music space/1.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12 routeSpotIntro">
                On the left side of the entrance on the first floor of A grid,
                there is a classroom space filled with sofa chairs, which are
                open 24 hours, you can study here in any position, the sofa
                chairs are very comfortable, the light is very bright, and this
                area is open 24 hours. If you like a relaxed learning style,
                this is the place for you; However, there are radio broadcasts
                on weekdays, so if you prefer a quiet study environment, this
                may not be the right place for you.
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                <a href="./route5-stop4.php">
