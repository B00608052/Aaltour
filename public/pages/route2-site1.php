          ...
          <div class="col-xs-12 col-sm-6">
            <div class="row">
              <div class="col-7">
                <div class="col-12 firstRouteSitePic">
                  <img
                    src="../images/route2/2.Life instruction/1.shopping center/3.jpg"
                    alt=""
                  />
                </div>
              </div>
              <div class="col-5">
                ...
                <div class="col-12 smallRouteSitePic smallRouteSitePic2">
                  <img
                    src="../images/route2/2.Life instruction/1.shopping center/4.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12 routeSpotIntro">
                A Bloc is located on the campus of Aalto University. The
                shopping center’s unique location at the heart of the university
                enables new forms of cooperation when developing the center. In
                the future, A Bloc will develop different kinds of retail
                concepts and new ways of thinking within the shopping center
                industry together with the retailers, students, and the
                university community.
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                <a href="./route2-stop2.php">
