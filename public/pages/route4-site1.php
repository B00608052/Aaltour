      ...
      >
        <div class="row">
          <div class="col-xs-12 col-sm-6">
            <div class="row">
              <h2 class="col-12 fs-1 fw-bold routeSpotTitle">Otaranta Beach</h2>
            </div>
            <div class="row">
          ...
          <div class="col-xs-12 col-sm-6">
            <div class="row">
              ...
              <div class="col-5">
                <div class="col-12 smallRouteSitePic smallRouteSitePic1">
                  <img
                    src="../images/route4/4.Spare time/1.Otaranta beach/2.jpg"
                    alt=""
                  />
                </div>
                <div class="col-12 smallRouteSitePic smallRouteSitePic2">
                  <img
                    src="../images/route4/4.Spare time/1.Otaranta beach/3.png"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12 routeSpotIntro">
                Otaranta beach is a serene spot for a stroll or for a refreshing
                dip in the Baltic Sea. You'll also find student housing, the
                sports hall, and a hotel near the beach.
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                <a href="./route4-stop2.php">
