                    ...
                    if (navigator.geolocation) {
                      navigator.geolocation.getCurrentPosition(
                        function (position) {
                          ...
                          var destination = {
                            lat: 60.184880762400994,
                            lng: 24.831054212341193,
                          };
            ...
            <div class="row">
              <div class="col-7">
                <div class="col-12 firstRouteSitePic">
                  <img src="../images/route3/3.Sculpture New/3/3.jpeg" alt="" />
                </div>
              </div>
              <div class="col-5">
                <div class="col-12 smallRouteSitePic smallRouteSitePic1">
                  <img src="../images/route3/3.Sculpture New/3/2.jpeg" alt="" />
                </div>
                <div class="col-12 smallRouteSitePic smallRouteSitePic2">
                  <img src="../images/route3/3.Sculpture New/3/4.png" alt="" />
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-12 routeSpotIntro">
                A magnification of the Pro Teekkari statue made of concrete
                (weight 7 tonnes, diameter over 3 m) was handed over to the City
                of Espoo. The statue is similar to the one received by the City
                of Helsinki 40 years earlier. The statue is located in front of
                Dipoli, at the intersection of Luolamiehentie and Otakaari.
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                <a href="./route3-stop4.php">
