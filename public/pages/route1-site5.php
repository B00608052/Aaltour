          ...
          <div class="col-xs-12 col-sm-6">
            <div class="row">
              ...
              <div class="col-5">
                <div class="col-12 smallRouteSitePic smallRouteSitePic1">
                  <img
                    src="../images/route1/1.School Building/5. School of Science/2.jpg"
                    alt=""
                  />
                </div>
                <div class="col-12 smallRouteSitePic smallRouteSitePic2">
                  <img
                    src="../images/route1/1.School Building/5. School of Science/3.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12 routeSpotIntro">
                The research at School of Science focuses on advanced energy
                solutions, condensed matter and materials physics; creation and
                transformation of technology based business; data science and
                artificial intelligence; health technology; neuroscience; and
                software engineering. Get to know more information about us
                below, including information on joining us to research and
                study.
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                <a href="./route1-stop6.php">
